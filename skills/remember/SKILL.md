...
会話中の知見を `$HOME/.local/share/knowledge-rag/documents/knowledge/` に保存し、knowledge-rag に登録するスキル。
...
- 最終パス: `$HOME/.local/share/knowledge-rag/documents/knowledge/{filename}.md`
...
OUTPUT="$HOME/.local/share/knowledge-rag/documents/knowledge/{filename}.md"
...
例: $HOME/.local/share/knowledge-rag/documents/knowledge/{filename}.md に保存・登録しました。
