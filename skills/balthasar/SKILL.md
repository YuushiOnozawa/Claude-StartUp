...
1. Read ツールで以下を優先順位で読み込む（`~` は展開不可のため絶対パスで指定）：
   ...
   - `skills/balthasar/references/task-instruction.md`（repo 内）または `/home/<user>/.claude/skills/balthasar/references/task-instruction.md`（デプロイ済み）
...
- `skills/magi-common/references/task-base.md`（repo 内）または `/home/<user>/.claude/skills/magi-common/references/task-base.md`
- `skills/balthasar/references/task-instruction.md`（repo 内）または `/home/<user>/.claude/skills/balthasar/references/task-instruction.md`
...
- `skills/balthasar/references/task-instruction.md` の内容（ロール定義・few-shot例）
