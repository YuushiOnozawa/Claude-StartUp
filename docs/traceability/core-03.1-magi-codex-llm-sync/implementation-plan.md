...
| IMPL-03.1-04 | ✅ 実装済み | PR #308（2026-07-14 マージ。対象は #289 により旧5箇所 → 現3箇所） |
| IMPL-03.1-05 | ✅ 実装済み | PR #307（2026-07-14 マージ） |
...
| IMPL-03.1-07 | ✅ 検証済み | PR #307 で確認（`git diff setup/850-codex.sh` 差分なし） |
