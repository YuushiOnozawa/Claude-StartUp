...
| REQ-03.1-06 | SKILL.md の `OLLAMA_MODEL` 記載は「WindowsホストOllamaに必要なモデル」の文書として維持する。LELIEL は `deepseek-r1:8b`、METATRON は `devstral:latest`（継続）、他は現状を正とする | 2026-07-07 確定 |
