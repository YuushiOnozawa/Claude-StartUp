...
## core-03.1 からの引き継ぎ（2026-07-16 記録）

- **Codex CLI 動作確認済みバージョンの README 記載**: core-03.1 REQ-03.1-07 / SPEC-03.1-07 が
  本 core の実装 PR に委任した項目（core-03.1 監査 A-004 で引き継ぎを明記）。
  850-codex.sh 変更時に確認済みバージョンをリポジトリ README へ記載すること
...
| specification.md | approved | 人間確認・承認済み（2026-07-08） |
| implementation-plan.md | approved | PR-A/B/C 分割・Codex レビュー対応済み。人間承認済み（2026-07-08） |
