...
最終更新: 2026-07-07（全 core requirements approved 完了 / core-02 specification approved）
...
| [core-02-live-deploy-drift](core-02-live-deploy-drift/README.md) — 実働環境で生まれた開発内容の還流経路が未定義（旧 core-05、旧名「本番とリポジトリの正の分裂」） | 必須 | high | **approved** | **approved** | draft | todo | todo | draft | todo |
