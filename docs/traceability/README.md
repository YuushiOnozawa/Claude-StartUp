...
最終更新: 2026-07-16（core-03.1 test approved・実装 verified。残は audit のみ）
...
| [core-03.1-magi-codex-llm-sync](core-03.1-magi-codex-llm-sync/README.md) — MAGI/Codex/ローカルLLM の実体・参照・割当ズレ（旧 core-02） | 必須 | high | **approved** | **approved** | **approved** | **verified** | **approved** | **approved** | todo |
...
- core-03.1: ✅ test approved・実装 verified（2026-07-16）→ 残は audit（Step 9）のみ
