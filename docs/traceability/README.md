...
最終更新: 2026-07-19（core-03.2 Step 7 design-review approved。HIGH 1 件 = #326 別トラック化。次は Step 8 test）
...
| [core-03.2-knowledge-distill-store](core-03.2-knowledge-distill-store/README.md) — hooks/蒸留/知識ストアの二重化・欠落・密結合（旧 core-03） | 必須 | high | **approved** | **approved** | **approved** | **implemented** | **approved** | draft | todo |
