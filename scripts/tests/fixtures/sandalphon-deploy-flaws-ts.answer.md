...
- `system.txt`: `skills/sandalphon/references/task-instruction.md`、`skills/sandalphon/references/review-criteria.md`、`skills/magi-common/references/output-format-v2.md`
